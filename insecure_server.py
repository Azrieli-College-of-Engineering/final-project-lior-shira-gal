    ...
    if not s.get("is_vip"):
        ...
        <body>
          <div class="card">
            ...
            <div class="info-box">
              <div class="info-title">⚠️ Vulnerability Hint</div>
              <div class="info-content">
                Your session is stored in a cookie named <code>booking_session</code>. 
                The server uses <code>pickle.loads()</code> on the cookie data.
                Maybe you can change your status?
              </div>
            </div>
      ...
      <div class="container">
        ...
        <div class="card">
          ...
          <div class="info-box">
            ...
            <div class="info-content">
              If you got here by modifying the session cookie, well done! 
              You successfully demonstrated the vulnerability of <code>pickle.loads()</code> on data 
              coming from the client. In a real environment, this vulnerability can be used not only 
              for privilege escalation, but even for remote code execution (RCE).
            </div>
          </div>
...
if __name__ == "__main__":
    print("🚀 SkyFly Flight Booking Demo")
    print("=" * 50)
    print("⚠️  This is a DEMONSTRATION of insecure deserialization")
    print("📍 Running on: http://127.0.0.1:5000")
    print("🔓 Vulnerability: pickle.loads() on client data")
    print("=" * 50)
